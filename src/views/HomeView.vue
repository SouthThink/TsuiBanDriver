...
<template>
  <el-tabs v-model="activeName" class="tabs" type="border-card" @tab-click="clickTab">
    ...
    <el-tab-pane :label="translate('时间表')" name="second">
      <TimeTablePage @go-search="handleGoSearch" />
    </el-tab-pane>
    <el-tab-pane :label="translate('搜索')" name="third" class="secondPage">
      <SearchPage />
    </el-tab-pane>
    <el-tab-pane :label="translate('订阅')" name="fourth">
      <SubscribePage v-if="activeName === 'fourth'" />
    </el-tab-pane>
